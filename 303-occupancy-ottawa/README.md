...
*  Lastly, our change-point model assumes that the COVID-19 reproduction number
   *R<sub>t</sub>* has the following form:
   ...
   <img src="https://latex.codecogs.com/svg.latex?\Large&space;R_{t}\;=\;R_{0}\cdot\exp\!\left(\;\sum^{{4}}_{k=1}\,\alpha_{k}\cdot{I}_{\{t\,-\,\gamma_{k}\}}\,\right)"/>
   ...
   *   *&gamma;<sub>k</sub>* is
       ...
       <img src="https://latex.codecogs.com/svg.latex?\Large&space;\gamma_{3}\;\sim\;\textnormal{\small{Uniform}}([\,2020/0{9}/0{6}\,,2020/10/03\,])"/>
       </br>
   ...
   *   *&alpha;<sub>k</sub>*
       ...
       <img src="https://latex.codecogs.com/svg.latex?\Large&space;\alpha_{2}\;\sim\;\textnormal{\small{Uniform}}([0,-\log(4),0])\,"/>
       </br>
