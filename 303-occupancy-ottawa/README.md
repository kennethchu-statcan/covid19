...
#  Ottawa COVID-19 hospital occupancy forecast (combining Model 1 & Model 2)
   ...
   <img src="https://latex.codecogs.com/svg.latex?\,\widehat{C}_{t}\;=\;\left(\,{\sum_{\tau=0}^{t_{*}}\,A_{\tau}}\,-{\sum_{\tau=t_{*}+1}^{t}\,A_{\tau}}\,\right)\,-\,\left(\,{\sum_{\tau=0}^{t_{*}}\,D_{\tau}}\,-{\sum_{\tau=t_{*}}^{t}\,D_{\tau}}\,\right)"/>
