...
*  Flaxman et al. assumed that each jurisdiction *m* has its own
   ...
   *&pi;<sub>&tau;</sub>* above is given by:
   ...
   <img src="https://latex.codecogs.com/svg.latex?\Large&space;\pi\;\sim\;\textnormal{\small{{IHR}}}_{}\cdot\left(\,\Gamma(\textnormal{{mean}}=5.1,=0.86)+\dfrac{1}{2}\cdot\Gamma(18.8,0.45)\,\right)"/>
