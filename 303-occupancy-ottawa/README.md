...
*  The number *c<sub>m,t</sub>* of COVID-19 infected individuals
   ...
   <img src="https://latex.codecogs.com/svg.latex?\Large&space;c_{t}\;=\;R_{t}\cdot\sum_{\tau=0}^{t-1}\left(\begin{array}{c}\textnormal{number\;infections}\\\textnormal{on\;day}\;\tau\end{array}\right)\cdot{g}_{t-\tau}"/>
   <br/>
