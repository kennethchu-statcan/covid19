...
```
cd <LOCAL CLONED REPOSITORY>/103-imperial-model-canada/
```
...
`<LOCAL CLONED REPOSITORY>/103-imperial-model-canada/output/`
...
*   __weighted-fatality-canada.csv__
    ...
    https://github.com/kennethchu-statcan/covid19/blob/master/103-imperial-model-canada/supplementary/input-wIFR.csv
