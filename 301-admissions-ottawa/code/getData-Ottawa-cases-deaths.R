...
getData.Ottawa.cases.deaths <- function(
    ...
    if ( file.exists(RData.ottawa) ) {
        ...
        ### ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
        DF.hospitalization <- getData.Ottawa.cases.deaths_standardize(
        ...
        DF.hospitalization <- getData.Ottawa.cases.deaths_add.discharge(
            DF.input = DF.hospitalization
            );

        ### ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
        DF.case <- getData.Ottawa.cases.deaths_standardize(
            DF.input = DF.case,
            list.replace.colnames = list(
        ...
        ### ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ###
        DF.death <- getData.Ottawa.cases.deaths_standardize(
            DF.input = DF.death,
            list.replace.colnames = list(
...
##################################################
getData.Ottawa.cases.deaths_add.discharge <- function(
    DF.input = NULL
    ) {
...
getData.Ottawa.cases.deaths_raw <- function(
    input.file  = NULL,
    input.sheet = NULL,
    output.file = NULL
    ) {
...
getData.Ottawa.cases.deaths_standardize <- function(
    DF.input              = NULL,
    list.replace.colnames = list(),
