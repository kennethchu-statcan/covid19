...
*  Lastly, our change-point model assumes that the COVID-19 reproduction number
   ...
   *   *&gamma;<sub>m,k</sub>* is
       ...
       <img src="https://latex.codecogs.com/svg.latex?\Large&space;\gamma_{m,3}\;\sim\;\textnormal{\small{Uniform}}([\,2020/05/01\,,\quad\textnormal{Present}\quad]),\;\textnormal{\small{for\;each}}\;\,m"/>
