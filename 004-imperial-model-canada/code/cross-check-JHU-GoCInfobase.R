...
##################################################
cross.check.JHU.GoCInfobase_reformat.GoCInfobase <- function(
    DF.input = NULL
    ) {
    require(dplyr);
    require(tidyr);
...
cross.check.JHU.GoCInfobase_reformat.JHU <- function(
    DF.input      = NULL,
    colname.value = NULL
    ) {
...
cross.check.JHU.GoCInfobase_download <- function(
    target.url = NULL
    ) {
    temp.file <- "temp.csv";
    tryCatch(
